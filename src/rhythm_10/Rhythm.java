...
public class Rhythm extends JFrame {
	...
	public Rhythm() {
		...
		trackList.add(new Track("Sonic Blaster Title Image.png", "Sonic Blaster Start Image.png",
				"Sonic Blaster Game Image.jpg", "Sonic Blaster Selected.mp3", "F-777 - Time Leaper.mp3"));
	...
	private void screenDraw(Graphics2D g) {
		...
		if (isGameScreen) {
			...
			g.drawString("Hinkik - Time Leaper", 20, 702);
