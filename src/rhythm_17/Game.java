	...
	public void dropNotes(String titleName) {
		...
		if (titleName.equals("Hinkik - Time Leaper")) {
			...
			beats = new Beat[] { 
					...
					new Beat(startTime + gap * 354, "Space"),
					...
					new Beat(startTime + gap * 386, "L"),
					new Beat(startTime + gap * 387, "S"),
					new Beat(startTime + gap * 387, "L"),
					new Beat(startTime + gap * 388, "S"),
					new Beat(startTime + gap * 388, "L"),
					new Beat(startTime + gap * 390, "Space"),
					...
					new Beat(startTime + gap * 402, "L"),
					new Beat(startTime + gap * 403, "S"),
					new Beat(startTime + gap * 403, "L"),
					...
					new Beat(startTime + gap * 416, "L"),
					new Beat(startTime + gap * 417, "S"),
					new Beat(startTime + gap * 417, "L"),
					new Beat(startTime + gap * 418, "S"),
					new Beat(startTime + gap * 418, "L"),
					new Beat(startTime + gap * 419, "S"),
					...
					new Beat(startTime + gap * 423, "L"),
					new Beat(startTime + gap * 424, "Space"),
					...
					new Beat(startTime + gap * 449, "S"),
					new Beat(startTime + gap * 449, "L"),
